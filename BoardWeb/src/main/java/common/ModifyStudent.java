...
public class ModifyStudent extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		str += "<tr><th>학번</th><td><input type='text' readonly name='sno' value='"+std.getStudentNumber()+"'></td></tr>";
		...
		str += "<tr><th>수학</th><td><input type='number' name='mscore' value='"+std.getMathmaticScore()+"'></td></tr>";
