...
public class StudentListServ extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for(Student std : list) {
			str += "<tr><td><a href='getStudentServlet?sno="+std.getStudentNumber()+"'>" + std.getStudentNumber() +"</a>"
					+"</td><td>" + std.getStudentName()
					+"</td><td>" + std.getEnglishScore() 
					+"</td><td>" + std.getMathmaticScore() +"</td></tr>";
